...
import S4_group
layers = layer3D(S4_group) # The layers is instantiated with the group structure as input
...
class Net(nn.Module):
    def __init__(self, net_name):
        ...
        self.conv1g = layers.ConvRnG(1,7,3, padding = 0).float()
        self.bn1  = BN_group(7)
        self.elu1 = nn.LeakyReLU()
        
        self.conv2g = layers.ConvGG(7,7,3, padding = 0).float()
        self.bn2  = BN_group(7)
        self.elu2 = nn.LeakyReLU()

        self.conv3g = layers.ConvGG(7,7,2, padding = 0).float()
        self.bn3  = BN_group(7)
        self.elu3 = nn.LeakyReLU()

        self.conv4g = layers.ConvGG(7,7,2, padding = 0).float()
        self.bn4  = BN_group(7)
        self.elu4 = nn.LeakyReLU()

        self.conv5g = layers.ConvGG(7,7,3, padding = 0).float()
        self.bn5  = BN_group(7)
        self.elu5 = nn.LeakyReLU()


        self.conv6g = layers.ConvGG(7,22,3, padding = 0).float()
